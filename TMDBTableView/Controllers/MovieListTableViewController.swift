...
extension MovieListTableViewController {
    private func configureTableViewDelegates() {
        movieListView.movieTableView.delegate = self
        movieListView.movieTableView.dataSource = self
    }
...
extension MovieListTableViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        movieListView.movieTableView.deselectRow(at: indexPath, animated: true)
